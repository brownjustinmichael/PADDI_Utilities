...
chem_axis = plt.subplot2grid((3, 4), (1, 0), colspan=2)
temp_spec_axis = plt.subplot2grid((3, 4), (0, 2))
chem_spec_axis = plt.subplot2grid((3, 4), (1, 2))
temp_prof_axis = plt.subplot2grid((3, 4), (0, 3))
chem_prof_axis = plt.subplot2grid((3, 4), (1, 3))

ux_prof_axis = plt.subplot2grid((3, 4), (2, 0))
uy_prof_axis = plt.subplot2grid((3, 4), (2, 1))
uz_prof_axis = plt.subplot2grid((3, 4), (2, 2))
rho_prof_axis = plt.subplot2grid((3, 4), (2, 3))
